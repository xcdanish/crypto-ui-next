    ...
    <>
      {isLoading ? (
        ...
        <MainCard
          ...
          content={false}
          sx={{
            bgcolor: theme.palette.mode === ThemeMode.DARK ? 'dark.dark' : 'grey.700',
            color: '#fff',
            overflow: 'hidden',
            position: 'relative',
            borderRadius: '15px',
            ...
            '&:after': {
              ...
              background:
                theme.palette.mode === ThemeMode.DARK
                  ? `linear-gradient(210.04deg, ${theme.palette.dark.dark} -50.94%, rgba(144, 202, 249, 0) 95.49%)`
            ...
            '&:before': {
              ...
              background:
                theme.palette.mode === ThemeMode.DARK
                  ? `linear-gradient(140.9deg, ${theme.palette.dark.dark} -14.02%, rgba(144, 202, 249, 0) 85.50%)`
                  : theme.palette.dark[800],
              borderRadius: '50%',
              top: { xs: -155, sm: -125 },
              right: { xs: -70, sm: -15 },
                  ...
                  <Grid item>
                    <Avatar
                      ...
                      sx={{
                        ...
                        bgcolor: theme.palette.mode === ThemeMode.DARK ? 'dark.main' : 'dark.800',
                        color: '#fff'
                        // mt: 1
                      }}
                    >
...
GrayBarChart.propTypes = {
  isLoading: PropTypes.bool
};

export default GrayBarChart;
