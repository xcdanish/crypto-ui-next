...
const WarningBarChart = ({ isLoading }) => {
    ...
    <>
      {isLoading ? (
        ...
        <MainCard
          ...
          content={false}
          sx={{
            bgcolor: theme.palette.mode === ThemeMode.DARK ? 'dark.dark' : 'warning.dark',
            color: '#fff',
            overflow: 'hidden',
            position: 'relative',
            borderRadius: '15px',
            ...
            '&:after': {
              ...
              background:
                theme.palette.mode === ThemeMode.DARK
                  ? `linear-gradient(210.04deg, ${theme.palette.warning.dark} -50.94%, rgba(144, 202, 249, 0) 95.49%)`
            ...
            '&:before': {
              ...
              background:
                theme.palette.mode === ThemeMode.DARK
                  ? `linear-gradient(140.9deg, ${theme.palette.warning.dark} -14.02%, rgba(144, 202, 249, 0) 85.50%)`
                  : theme.palette.warning.main,
              borderRadius: '50%',
              top: { xs: -155, sm: -125 },
              right: { xs: -70, sm: -15 },
                  ...
                  <Grid item>
                    <Avatar
                      ...
                      sx={{
                        ...
                        bgcolor: theme.palette.mode === ThemeMode.DARK ? 'dark.main' : 'warning.main',
                        color: '#fff'
                        // mt: 1
                      }}
                    >
